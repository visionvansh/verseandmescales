//Volumes/vision/codes/course/my-app/src/app/users/studio/card-customisation/page.tsx
"use client";
...
const CardCustomisationPage = () => {
 ...
 const handleContinue = async () => {
  ...
  // ✅ Navigate to studio course-builder instead of homepage-builder
  router.push(`/users/studio/course-builder?courseId=${courseId}`);
};
            ...
            <div className="relative p-4 sm:p-5">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                 <m.button
  onClick={() => router.push("/users/studio/dashboard")} // ✅ Go back to studio dashboard
